...
DROP TABLE t1
CREATE TABLE IF NOT EXISTS t1(a INT NOT NULL UNIQUE,b INT NOT NULL,c INT NOT NULL);
...
CREATE TABLE t2(id TINYINT NOT NULL,val TINYINT NOT NULL);
INSERT INTO t2 VALUES(1,100)
SELECT * FROM t2
DROP TRIGGER IF EXISTS mydata_on_mysql_v8.upc_t1;
DELIMITER //
CREATE TRIGGER mydata_on_mysql_v8.upc_t1 AFTER INSERT ON mydata_on_mysql_v8.t2
FOR EACH ROW
BEGIN
	INSERT INTO mydata_on_mysql_v8.t1 VALUES(new.id,new.val,0)
