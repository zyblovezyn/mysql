...
SET @v1=b'1000001',@v2=b'1000001'+0,@v3=CAST(b'1000001' AS UNSIGNED);
SELECT @v1,@v2,@v3;

SELECT EXTRACT(YEAR FROM '2019-07-02');

SELECT EXTRACT(YEAR_MONTH FROM '2019-09-09');

CREATE EVENT myevent ON SCHEDULE AT CURRENT_TIMESTAMP + INTERVAL 1 HOUR
DO UPDATE mydata_on_mysql_v8.ab SET a=a+1;
...
SELECT DATE_ADD('2019-01-01 12:00:00',INTERVAL CAST(6/4 AS DECIMAL(3,1)) HOUR_MINUTE);
